...
[Source](../../src/rustc_ast/ast.rs.html#2131-2140)
...
The âsemanticâ representation of the literal lowered from the original tokens.
...
[Source](../../src/rustc_ast/util/literal.rs.html#217-253)

### impl [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

[Source](../../src/rustc_ast/util/literal.rs.html#219-226)

#### pub fn [from\_token\_lit](#method.from_token_lit)( token\_lit: [Lit](../token/struct.Lit.html "struct rustc_ast::token::Lit"), span: [Span](../../rustc_span/span_encoding/struct.Span.html "struct rustc_span::span_encoding::Span"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit"), [LitError](../util/literal/enum.LitError.html "enum rustc_ast::util::literal::LitError")>

Converts a token literal into a meta item literal.

[Source](../../src/rustc_ast/util/literal.rs.html#229-246)

#### pub fn [as\_token\_lit](#method.as_token_lit)(&self) -> [Lit](../token/struct.Lit.html "struct rustc_ast::token::Lit")

Cheaply converts a meta item literal into a token literal.

[Source](../../src/rustc_ast/util/literal.rs.html#249-252)

#### pub fn [from\_token](#method.from_token)(token: &[Token](../token/struct.Token.html "struct rustc_ast::token::Token")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")>

Converts an arbitrary token into meta item literal.

[Source](../../src/rustc_ast/attr/mod.rs.html#744-748)

### impl [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

[Source](../../src/rustc_ast/attr/mod.rs.html#745-747)
...
[Source](../../src/rustc_ast/ast.rs.html#2130)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

[Source](../../src/rustc_ast/ast.rs.html#2130)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")
...
### impl<\_\_CTX> [HashStable](../../rustc_data_structures/stable_hasher/trait.HashStable.html "trait rustc_data_structures::stable_hasher::HashStable")<\_\_CTX> for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit") where \_\_CTX: [HashStableContext](../trait.HashStableContext.html "trait rustc_ast::HashStableContext"),
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

## Auto Trait Implementations

### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MetaItemLit](struct.MetaItemLit.html "struct rustc_ast::ast::MetaItemLit")
