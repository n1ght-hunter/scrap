...
[Source](../../src/rustc_ast/ast.rs.html#2935-2938)
...
Please note that itâs different from `FnHeader` structure
...
[Source](../../src/rustc_ast/ast.rs.html#2940-2947)

### impl [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

[Source](../../src/rustc_ast/ast.rs.html#2941-2943)

#### pub fn [has\_self](#method.has_self)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

[Source](../../src/rustc_ast/ast.rs.html#2944-2946)

#### pub fn [c\_variadic](#method.c_variadic)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#2934)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

[Source](../../src/rustc_ast/ast.rs.html#2934)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FnDecl](struct.FnDecl.html "struct rustc_ast::ast::FnDecl")
