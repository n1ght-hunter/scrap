...
[Source](../../src/rustc_ast/ast.rs.html#856-934)
...
### Ident([BindingMode](struct.BindingMode.html "struct rustc_ast::ast::BindingMode"), [Ident](../../rustc_span/symbol/struct.Ident.html "struct rustc_span::symbol::Ident"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>>)
...
### Struct([Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[QSelf](struct.QSelf.html "struct rustc_ast::ast::QSelf")>>, [Path](struct.Path.html "struct rustc_ast::ast::Path"), [ThinVec](https://docs.rs/thin-vec/0.2.14/thin_vec/struct.ThinVec.html "struct thin_vec::ThinVec")<[PatField](struct.PatField.html "struct rustc_ast::ast::PatField")>, [PatFieldsRest](enum.PatFieldsRest.html "enum rustc_ast::ast::PatFieldsRest"))

A struct or struct variant pattern (e.g., `Variant {x, y, ..}`).

### TupleStruct([Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[QSelf](struct.QSelf.html "struct rustc_ast::ast::QSelf")>>, [Path](struct.Path.html "struct rustc_ast::ast::Path"), [ThinVec](https://docs.rs/thin-vec/0.2.14/thin_vec/struct.ThinVec.html "struct thin_vec::ThinVec")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>>)

A tuple struct/variant pattern (`Variant(x, y, .., z)`).

### Or([ThinVec](https://docs.rs/thin-vec/0.2.14/thin_vec/struct.ThinVec.html "struct thin_vec::ThinVec")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>>)
...
### Tuple([ThinVec](https://docs.rs/thin-vec/0.2.14/thin_vec/struct.ThinVec.html "struct thin_vec::ThinVec")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>>)

A tuple pattern (`(a, b)`).

### Box([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>)

A `box` pattern.

### Deref([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>)

A `deref` pattern (currently `deref!()` macro-based syntax).

### Ref([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>, [Mutability](enum.Mutability.html "enum rustc_ast::ast::Mutability"))

A reference pattern (e.g., `&mut (a, b)`).

### Expr([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")>)

A literal, const block or path.

### Range([Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")>>, [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")>>, [Spanned](../../rustc_span/source_map/struct.Spanned.html "struct rustc_span::source_map::Spanned")<[RangeEnd](enum.RangeEnd.html "enum rustc_ast::ast::RangeEnd")>)

A range pattern (e.g., `1...2`, `1..2`, `1..`, `..2`, `1..=2`, `..=2`).

### Slice([ThinVec](https://docs.rs/thin-vec/0.2.14/thin_vec/struct.ThinVec.html "struct thin_vec::ThinVec")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>>)
...
### Guard([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>, [Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")>)

A guard pattern (e.g., `x if guard(x)`).

### Paren([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Pat](struct.Pat.html "struct rustc_ast::ast::Pat")>)
...
Placeholder for a pattern that wasnât syntactically well formed in some way.

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#855)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

[Source](../../src/rustc_ast/ast.rs.html#855)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PatKind](enum.PatKind.html "enum rustc_ast::ast::PatKind")
