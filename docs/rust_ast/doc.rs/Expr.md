...
[Source](../../src/rustc_ast/ast.rs.html#1364-1370)
...
[Source](../../src/rustc_ast/ast.rs.html#1372-1632)

### impl [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

[Source](../../src/rustc_ast/ast.rs.html#1386-1399)

#### pub fn [is\_potential\_trivial\_const\_arg](#method.is_potential_trivial_const_arg)(&self, allow\_mgca\_arg: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Check if this expression is potentially a trivial const arg, i.e., one that can *potentially*
...
is a path, it mostly dispatches to [`Path::is_potential_trivial_const_arg`](struct.Path.html#method.is_potential_trivial_const_arg "method rustc_ast::ast::Path::is_potential_trivial_const_arg").
...
This also does not consider macros, so itâs only correct after macro-expansion.

[Source](../../src/rustc_ast/ast.rs.html#1402-1411)

#### pub fn [maybe\_unwrap\_block](#method.maybe_unwrap_block)(&self) -> &[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

Returns an expression with (when possible) *one* outer brace removed

[Source](../../src/rustc_ast/ast.rs.html#1418-1438)

#### pub fn [optionally\_braced\_mac\_call](#method.optionally_braced_mac_call)( &self, already\_stripped\_block: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), [NodeId](../node_id/struct.NodeId.html "struct rustc_ast::node_id::NodeId"))>
...
Returns the [`NodeId`](../node_id/struct.NodeId.html "struct rustc_ast::node_id::NodeId") of the macro call and whether a layer of braces has been peeled
either before, or part of, this function.

[Source](../../src/rustc_ast/ast.rs.html#1440-1451)

#### pub fn [to\_bound](#method.to_bound)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GenericBound](enum.GenericBound.html "enum rustc_ast::ast::GenericBound")>

[Source](../../src/rustc_ast/ast.rs.html#1453-1459)

#### pub fn [peel\_parens](#method.peel_parens)(&self) -> &[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

[Source](../../src/rustc_ast/ast.rs.html#1461-1468)

#### pub fn [peel\_parens\_and\_refs](#method.peel_parens_and_refs)(&self) -> &[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

[Source](../../src/rustc_ast/ast.rs.html#1471-1514)
...
[Source](../../src/rustc_ast/ast.rs.html#1516-1603)

#### pub fn [precedence](#method.precedence)(&self) -> [ExprPrecedence](../util/parser/enum.ExprPrecedence.html "enum rustc_ast::util::parser::ExprPrecedence")

[Source](../../src/rustc_ast/ast.rs.html#1606-1618)

#### pub fn [is\_approximately\_pattern](#method.is_approximately_pattern)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

To a first-order approximation, is this a pattern?

[Source](../../src/rustc_ast/ast.rs.html#1623-1631)

#### pub fn [dummy](#method.dummy)() -> [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
[Source](../../src/rustc_ast/ast.rs.html#1363)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

[Source](../../src/rustc_ast/ast.rs.html#1363)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
[Source](../../src/rustc_ast/ast.rs.html#1634-1638)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")>> for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

[Source](../../src/rustc_ast/ast.rs.html#1635-1637)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")>) -> Self

Converts to this type from the input type.

[Source](../../src/rustc_ast/ast_traits.rs.html#232-244)

### impl [HasAttrs](../ast_traits/trait.HasAttrs.html "trait rustc_ast::ast_traits::HasAttrs") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
#### fn [visit\_attrs](../ast_traits/trait.HasAttrs.html#tymethod.visit_attrs)(&mut self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [AttrVec](type.AttrVec.html "type rustc_ast::ast::AttrVec")))

[Source](../../src/rustc_ast/ast_traits.rs.html#36-53)

### impl [HasNodeId](../ast_traits/trait.HasNodeId.html "trait rustc_ast::ast_traits::HasNodeId") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
### impl [HasTokens](../ast_traits/trait.HasTokens.html "trait rustc_ast::ast_traits::HasTokens") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<V> for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

[Source](../../src/rustc_ast/mut_visit.rs.html#262)

#### fn [walk\_mut](../mut_visit/trait.MutWalkable.html#tymethod.walk_mut)(&mut self, vis: [&mut V](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> V::[Result](../mut_visit/sealed/trait.MutVisitorResult.html#associatedtype.Result "type rustc_ast::mut_visit::sealed::MutVisitorResult::Result")

[Source](../../src/rustc_ast/visit.rs.html#1117)

### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'a, V> for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

[Source](../../src/rustc_ast/visit.rs.html#1117)

#### fn [walk\_ref](../visit/trait.Walkable.html#tymethod.walk_ref)(&'a self, vis: [&mut V](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> V::[Result](../visit/trait.Visitor.html#associatedtype.Result "type rustc_ast::visit::Visitor::Result")

## Auto Trait Implementations

### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Expr](struct.Expr.html "struct rustc_ast::ast::Expr")
