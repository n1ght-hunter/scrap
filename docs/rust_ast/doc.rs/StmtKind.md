...
[Source](../../src/rustc_ast/ast.rs.html#1223-1236)
...
### Let([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Local](struct.Local.html "struct rustc_ast::ast::Local")>)

A local (let) binding.

### Item([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Item](struct.Item.html "struct rustc_ast::ast::Item")>)
...
### Semi([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Expr](struct.Expr.html "struct rustc_ast::ast::Expr")>)
...
### MacCall([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[MacCallStmt](struct.MacCallStmt.html "struct rustc_ast::ast::MacCallStmt")>)

Macro.

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#1222)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

[Source](../../src/rustc_ast/ast.rs.html#1222)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")
...
[Source](../../src/rustc_ast/ast_traits.rs.html#269-293)

### impl [HasAttrs](../ast_traits/trait.HasAttrs.html "trait rustc_ast::ast_traits::HasAttrs") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

[Source](../../src/rustc_ast/ast_traits.rs.html#272)

#### const [SUPPORTS\_CUSTOM\_INNER\_ATTRS](../ast_traits/trait.HasAttrs.html#associatedconstant.SUPPORTS_CUSTOM_INNER_ATTRS): [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html) = true
...
[Source](../../src/rustc_ast/ast_traits.rs.html#274-282)
...
[Source](../../src/rustc_ast/ast_traits.rs.html#284-292)
...
[Source](../../src/rustc_ast/ast_traits.rs.html#130-149)

### impl [HasTokens](../ast_traits/trait.HasTokens.html "trait rustc_ast::ast_traits::HasTokens") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

[Source](../../src/rustc_ast/ast_traits.rs.html#131-139)
...
[Source](../../src/rustc_ast/ast_traits.rs.html#140-148)
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [StmtKind](enum.StmtKind.html "enum rustc_ast::ast::StmtKind")
