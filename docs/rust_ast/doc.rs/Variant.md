...
[Source](../../src/rustc_ast/ast.rs.html#3184-3202)
...
[Source](../../src/rustc_ast/ast.rs.html#3183)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

[Source](../../src/rustc_ast/ast.rs.html#3183)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl [HasAttrs](../ast_traits/trait.HasAttrs.html "trait rustc_ast::ast_traits::HasAttrs") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl [HasNodeId](../ast_traits/trait.HasNodeId.html "trait rustc_ast::ast_traits::HasNodeId") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl [HasTokens](../ast_traits/trait.HasTokens.html "trait rustc_ast::ast_traits::HasTokens") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Variant](struct.Variant.html "struct rustc_ast::ast::Variant")
