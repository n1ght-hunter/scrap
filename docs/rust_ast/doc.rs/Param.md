...
[Source](../../src/rustc_ast/ast.rs.html#2807-2814)
...
[Source](../../src/rustc_ast/ast.rs.html#2847-2926)

### impl [Param](struct.Param.html "struct rustc_ast::ast::Param")

[Source](../../src/rustc_ast/ast.rs.html#2849-2870)

#### pub fn [to\_self](#method.to_self)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ExplicitSelf](type.ExplicitSelf.html "type rustc_ast::ast::ExplicitSelf")>

Attempts to cast parameter to `ExplicitSelf`.

[Source](../../src/rustc_ast/ast.rs.html#2873-2879)

#### pub fn [is\_self](#method.is_self)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if parameter is `self`.

[Source](../../src/rustc_ast/ast.rs.html#2882-2925)

#### pub fn [from\_self](#method.from_self)( attrs: [AttrVec](type.AttrVec.html "type rustc_ast::ast::AttrVec"), eself: [ExplicitSelf](type.ExplicitSelf.html "type rustc_ast::ast::ExplicitSelf"), eself\_ident: [Ident](../../rustc_span/symbol/struct.Ident.html "struct rustc_span::symbol::Ident"), ) -> [Param](struct.Param.html "struct rustc_ast::ast::Param")

Builds a `Param` object from `ExplicitSelf`.

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#2806)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

[Source](../../src/rustc_ast/ast.rs.html#2806)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl [HasAttrs](../ast_traits/trait.HasAttrs.html "trait rustc_ast::ast_traits::HasAttrs") for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl [HasNodeId](../ast_traits/trait.HasNodeId.html "trait rustc_ast::ast_traits::HasNodeId") for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
[Source](../../src/rustc_ast/ast_traits.rs.html#101-110)

### impl [HasTokens](../ast_traits/trait.HasTokens.html "trait rustc_ast::ast_traits::HasTokens") for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [Param](struct.Param.html "struct rustc_ast::ast::Param") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [Param](struct.Param.html "struct rustc_ast::ast::Param")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [Param](struct.Param.html "struct rustc_ast::ast::Param") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Param](struct.Param.html "struct rustc_ast::ast::Param")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Param](struct.Param.html "struct rustc_ast::ast::Param")
