...
[Source](../../src/rustc_ast/ast.rs.html#1149-1156)
...
Note that `&data` is not an operator, itâs an `AddrOf` expression.
...
[Source](../../src/rustc_ast/ast.rs.html#1158-1171)

### impl [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

[Source](../../src/rustc_ast/ast.rs.html#1159-1165)

#### pub fn [as\_str](#method.as_str)(&self) -> &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

[Source](../../src/rustc_ast/ast.rs.html#1168-1170)
...
[Source](../../src/rustc_ast/ast.rs.html#1148)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

[Source](../../src/rustc_ast/ast.rs.html#1148)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")
...
### impl<\_\_CTX> [HashStable](../../rustc_data_structures/stable_hasher/trait.HashStable.html "trait rustc_data_structures::stable_hasher::HashStable")<\_\_CTX> for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp") where \_\_CTX: [HashStableContext](../trait.HashStableContext.html "trait rustc_ast::HashStableContext"),
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

[Source](../../src/rustc_ast/ast.rs.html#1148)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

[Source](../../src/rustc_ast/ast.rs.html#1148)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

## Auto Trait Implementations

### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UnOp](enum.UnOp.html "enum rustc_ast::ast::UnOp")
