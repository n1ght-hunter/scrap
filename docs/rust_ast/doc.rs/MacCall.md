...
[Source](../../src/rustc_ast/ast.rs.html#2001-2004)
...
[Source](../../src/rustc_ast/ast.rs.html#2006-2010)

### impl [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

[Source](../../src/rustc_ast/ast.rs.html#2007-2009)

#### pub fn [span](#method.span)(&self) -> [Span](../../rustc_span/span_encoding/struct.Span.html "struct rustc_span::span_encoding::Span")

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#2000)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

[Source](../../src/rustc_ast/ast.rs.html#2000)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MacCall](struct.MacCall.html "struct rustc_ast::ast::MacCall")
