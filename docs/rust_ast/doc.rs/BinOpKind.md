...
[Source](../../src/rustc_ast/ast.rs.html#967-1004)
...
[Source](../../src/rustc_ast/ast.rs.html#1006-1072)

### impl [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

[Source](../../src/rustc_ast/ast.rs.html#1007-1029)

#### pub fn [as\_str](#method.as_str)(&self) -> &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

[Source](../../src/rustc_ast/ast.rs.html#1031-1033)

#### pub fn [is\_lazy](#method.is_lazy)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

[Source](../../src/rustc_ast/ast.rs.html#1035-1048)
...
[Source](../../src/rustc_ast/ast.rs.html#1050-1058)

#### pub fn [fixity](#method.fixity)(&self) -> [Fixity](../util/parser/enum.Fixity.html "enum rustc_ast::util::parser::Fixity")

[Source](../../src/rustc_ast/ast.rs.html#1060-1066)

#### pub fn [is\_comparison](#method.is_comparison)(self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

[Source](../../src/rustc_ast/ast.rs.html#1069-1071)

#### pub fn [is\_by\_value](#method.is_by_value)(self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the binary operator takes its arguments by value.

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#966)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

[Source](../../src/rustc_ast/ast.rs.html#966)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")
...
[Source](../../src/rustc_ast/ast.rs.html#1079-1094)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[AssignOpKind](enum.AssignOpKind.html "enum rustc_ast::ast::AssignOpKind")> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

[Source](../../src/rustc_ast/ast.rs.html#1080-1093)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(op: [AssignOpKind](enum.AssignOpKind.html "enum rustc_ast::ast::AssignOpKind")) -> [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

Converts to this type from the input type.

[Source](../../src/rustc_ast/ast.rs.html#966)

### impl<\_\_CTX> [HashStable](../../rustc_data_structures/stable_hasher/trait.HashStable.html "trait rustc_data_structures::stable_hasher::HashStable")<\_\_CTX> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind") where \_\_CTX: [HashStableContext](../trait.HashStableContext.html "trait rustc_ast::HashStableContext"),
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

[Source](../../src/rustc_ast/ast.rs.html#966)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

[Source](../../src/rustc_ast/ast.rs.html#966)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

## Auto Trait Implementations

### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BinOpKind](enum.BinOpKind.html "enum rustc_ast::ast::BinOpKind")
