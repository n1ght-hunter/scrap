...
[Source](../../src/rustc_ast/ast.rs.html#483-491)
...
[Source](../../src/rustc_ast/ast.rs.html#493-497)

### impl [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

[Source](../../src/rustc_ast/ast.rs.html#494-496)

#### pub fn [is\_empty](#method.is_empty)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#482)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

[Source](../../src/rustc_ast/ast.rs.html#482)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

[Source](../../src/rustc_ast/ast.rs.html#482)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WhereClause](struct.WhereClause.html "struct rustc_ast::ast::WhereClause")
