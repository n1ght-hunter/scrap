...
[Source](../../src/rustc_ast/ast.rs.html#1247-1257)
...
[Source](../../src/rustc_ast/ast.rs.html#1246)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

[Source](../../src/rustc_ast/ast.rs.html#1246)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

[Source](../../src/rustc_ast/ast.rs.html#1246)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

[Source](../../src/rustc_ast/ast.rs.html#1246)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

## Auto Trait Implementations

### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MacStmtStyle](enum.MacStmtStyle.html "enum rustc_ast::ast::MacStmtStyle")
