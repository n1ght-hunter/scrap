...
[Source](../../src/rustc_ast/ast.rs.html#475-479)
...
[Source](../../src/rustc_ast/ast.rs.html#474)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

[Source](../../src/rustc_ast/ast.rs.html#474)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

[Source](../../src/rustc_ast/ast.rs.html#474)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Generics](struct.Generics.html "struct rustc_ast::ast::Generics")
