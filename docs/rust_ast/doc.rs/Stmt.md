...
[Source](../../src/rustc_ast/ast.rs.html#1177-1181)
...
[Source](../../src/rustc_ast/ast.rs.html#1183-1219)

### impl [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

[Source](../../src/rustc_ast/ast.rs.html#1184-1190)

#### pub fn [has\_trailing\_semicolon](#method.has_trailing_semicolon)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

[Source](../../src/rustc_ast/ast.rs.html#1199-1210)

#### pub fn [add\_trailing\_semicolon](#method.add_trailing_semicolon)(self) -> Self
...
[Source](../../src/rustc_ast/ast.rs.html#1212-1214)

#### pub fn [is\_item](#method.is_item)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

[Source](../../src/rustc_ast/ast.rs.html#1216-1218)

#### pub fn [is\_expr](#method.is_expr)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#1176)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

[Source](../../src/rustc_ast/ast.rs.html#1176)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")
...
[Source](../../src/rustc_ast/ast_traits.rs.html#295-303)

### impl [HasAttrs](../ast_traits/trait.HasAttrs.html "trait rustc_ast::ast_traits::HasAttrs") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

[Source](../../src/rustc_ast/ast_traits.rs.html#296)
...
[Source](../../src/rustc_ast/ast_traits.rs.html#297-299)
...
[Source](../../src/rustc_ast/ast_traits.rs.html#300-302)
...
### impl [HasNodeId](../ast_traits/trait.HasNodeId.html "trait rustc_ast::ast_traits::HasNodeId") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")
...
[Source](../../src/rustc_ast/ast_traits.rs.html#151-158)

### impl [HasTokens](../ast_traits/trait.HasTokens.html "trait rustc_ast::ast_traits::HasTokens") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

[Source](../../src/rustc_ast/ast_traits.rs.html#152-154)
...
[Source](../../src/rustc_ast/ast_traits.rs.html#155-157)
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Stmt](struct.Stmt.html "struct rustc_ast::ast::Stmt")
