...
[Source](../../src/rustc_ast/ast.rs.html#3536-3545)
...
[Source](../../src/rustc_ast/ast.rs.html#3547-3588)

### impl [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

[Source](../../src/rustc_ast/ast.rs.html#3549-3555)

#### pub fn [has\_qualifiers](#method.has_qualifiers)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Does this function header have any qualifiers or is it empty?

[Source](../../src/rustc_ast/ast.rs.html#3558-3587)

#### pub fn [span](#method.span)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Span](../../rustc_span/span_encoding/struct.Span.html "struct rustc_span::span_encoding::Span")>

Return a span encompassing the header, or none if all options are default.

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#3535)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

[Source](../../src/rustc_ast/ast.rs.html#3535)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")
...
[Source](../../src/rustc_ast/ast.rs.html#3590-3599)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

[Source](../../src/rustc_ast/ast.rs.html#3591-3598)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

Returns the âdefault valueâ for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](../../src/rustc_ast/ast.rs.html#3535)

### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

## Auto Trait Implementations

### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FnHeader](struct.FnHeader.html "struct rustc_ast::ast::FnHeader")
