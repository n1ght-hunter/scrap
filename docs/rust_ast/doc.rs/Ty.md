...
[Source](../../src/rustc_ast/ast.rs.html#2342-2347)
...
[Source](../../src/rustc_ast/ast.rs.html#2366-2383)

### impl [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

[Source](../../src/rustc_ast/ast.rs.html#2367-2374)

#### pub fn [peel\_refs](#method.peel_refs)(&self) -> &Self

[Source](../../src/rustc_ast/ast.rs.html#2376-2382)

#### pub fn [is\_maybe\_parenthesised\_infer](#method.is_maybe_parenthesised_infer)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

## Trait Implementations

[Source](../../src/rustc_ast/ast.rs.html#2349-2358)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

[Source](../../src/rustc_ast/ast.rs.html#2350-2357)
...
[Source](../../src/rustc_ast/ast.rs.html#2341)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
### impl<\_\_D: [SpanDecoder](../../rustc_span/trait.SpanDecoder.html "trait rustc_span::SpanDecoder")> [Decodable](../../rustc_serialize/serialize/trait.Decodable.html "trait rustc_serialize::serialize::Decodable")<\_\_D> for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
### impl<\_\_E: [SpanEncoder](../../rustc_span/trait.SpanEncoder.html "trait rustc_span::SpanEncoder")> [Encodable](../../rustc_serialize/serialize/trait.Encodable.html "trait rustc_serialize::serialize::Encodable")<\_\_E> for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
[Source](../../src/rustc_ast/ast.rs.html#2360-2364)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Ty](struct.Ty.html "struct rustc_ast::ast::Ty")>> for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

[Source](../../src/rustc_ast/ast.rs.html#2361-2363)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[Ty](struct.Ty.html "struct rustc_ast::ast::Ty")>) -> Self

Converts to this type from the input type.

[Source](../../src/rustc_ast/ast_traits.rs.html#245)

### impl [HasAttrs](../ast_traits/trait.HasAttrs.html "trait rustc_ast::ast_traits::HasAttrs") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
### impl [HasNodeId](../ast_traits/trait.HasNodeId.html "trait rustc_ast::ast_traits::HasNodeId") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
### impl [HasTokens](../ast_traits/trait.HasTokens.html "trait rustc_ast::ast_traits::HasTokens") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
### impl<V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor")> [MutVisitable](../mut_visit/trait.MutVisitable.html "trait rustc_ast::mut_visit::MutVisitable")<V> for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
### impl<\_\_V> [MutWalkable](../mut_visit/trait.MutWalkable.html "trait rustc_ast::mut_visit::MutWalkable")<\_\_V> for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty") where \_\_V: [MutVisitor](../mut_visit/trait.MutVisitor.html "trait rustc_ast::mut_visit::MutVisitor"),
...
### impl<'a, V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'a>> [Visitable](../visit/trait.Visitable.html "trait rustc_ast::visit::Visitable")<'a, V> for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
...
### impl<'\_\_ast, \_\_V> [Walkable](../visit/trait.Walkable.html "trait rustc_ast::visit::Walkable")<'\_\_ast, \_\_V> for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty") where \_\_V: [Visitor](../visit/trait.Visitor.html "trait rustc_ast::visit::Visitor")<'\_\_ast>,
...
### impl [DynSend](../../rustc_data_structures/marker/trait.DynSend.html "trait rustc_data_structures::marker::DynSend") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

### impl [DynSync](../../rustc_data_structures/marker/trait.DynSync.html "trait rustc_data_structures::marker::DynSync") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Ty](struct.Ty.html "struct rustc_ast::ast::Ty")
